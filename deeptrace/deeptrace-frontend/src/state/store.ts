...
import type { GdeltMatch } from '../api/types';
...
interface AppState {
  ...
  isLoading: boolean;
  lastSenseMatches: GdeltMatch[] | null;
  ...
  setLastSenseMatches: (matches: GdeltMatch[] | null) => void;
}
...
export const useStore = create<AppState>((set) => ({
  ...
  setLastSenseMatches: (matches) => set({ lastSenseMatches: matches }),
}));
